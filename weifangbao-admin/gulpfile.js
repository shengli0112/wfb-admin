...
// ftp 上传
// 添加一个任务，在全局安装 gulp 的前提下可以在目标目录下 执行 gulp dev-upload 启动这个任务
// upload 的名称可以自定义
gulp.task('dev-upload', function () {
  return gulp.src('./dist/**')
    .pipe(ftp({
      // 这个对象是服务器的配置，要根据实际情况修改
      host: 'xidi.admin.ruitukeji.top',
      user: 'xidi_admin_ruit',
      pass: '4QFpWdWrYhnm2arQ',
      port: 21,
