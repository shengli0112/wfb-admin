  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-demo__news">
      ...
      <el-table
        ...
        <el-table-column prop="title" :label="$t('news.title')" header-align="center" align="left"></el-table-column>
...
export default {
  ...
  methods: {
    previewHandle (id) {
      const preview = '<div class="photoImg">待开发...</div>';
    // <iframe class="content" src=' + url + '></iframe>
      this.$alert(preview, {
