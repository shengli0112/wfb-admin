  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-demo__news">
      ...
      <el-table
        ...
        <el-table-column prop="name" :label="$t('help.type')" header-align="center" align="center"></el-table-column>
  ...
  data () {
    return {
      mixinViewModuleOptions: {
        getDataListURL: 'helpcenter/type/page',
        getDataListIsPage: true,
        deleteURL: 'helpcenter/type',
        deleteIsBatch: true
      }
    }
  },
