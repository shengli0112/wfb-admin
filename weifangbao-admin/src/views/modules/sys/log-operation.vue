  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-sys__log-operation">
      ...
      <el-table v-loading="dataListLoading" :data="dataList" border @sort-change="dataListSortChangeHandle" style="width: 100%;">
        ...
        <el-table-column prop="requestParams" :label="$t('logOperation.requestParams')" header-align="center" align="center" width="250" :show-overflow-tooltip="true">
          <template slot-scope="scope">
            <div>
              <span class="params">{{scope.row.requestParams}}</span>
              <el-button class="tag-read" type="text" @click="copy(scope.row.requestParams)">复制参数</el-button>
              <!-- <el-button type="primary" icon="el-icon-document" size="small" circle @click="copy(scope.row.requestParams)></el-button> -->
            </div>
          </template>
        </el-table-column>
