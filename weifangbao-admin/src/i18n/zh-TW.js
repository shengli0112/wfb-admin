...
t.login.captcha = '驗證碼'
t.login.demo = '在線演示'
t.login.copyright = '睿途科技'

t.home = {}
t.home.sysInfo = {}
t.home.sysInfo.name = '系統名稱'
t.home.sysInfo.nameVal = 'xianbao-security【企業版】'
...
t.oss.aliyunDomainTips = '阿里雲綁定的域名，如：http://cdn.xianbao.io'
...
t.oss.localDomainTips = '綁定的域名，如：http://cdn.xianbao.io'
t.oss.fastdfsDomain = '域名'
t.oss.fastdfsDomainTips = '綁定的域名，如：http://cdn.xianbao.io'
...
/* Xshop */
t.member = {}
t.member.selectLevel = '請選擇會員等級'

t.member.lvName = '等級名稱'
t.member.lvCondition = '升級條件'
t.member.discount = '折扣率'
t.member.description = '等級描述'
