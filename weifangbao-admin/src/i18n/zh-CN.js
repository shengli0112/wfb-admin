...
t.login.password = '密码'
t.login.captcha = '验证码'
t.login.demo = '仙宝云提供云计算支持'
t.login.copyright = '微房宝'

t.home = {}
t.home.sysInfo = {}
t.home.sysInfo.name = '系统名称'
t.home.sysInfo.nameVal = '微房宝交易系统'
...
t.oss.aliyunDomainTips = '阿里云绑定的域名，如：http://cdn.xianbao.io'
...
t.oss.localDomainTips = '绑定的域名，如：http://cdn.xianbao.io'
t.oss.fastdfsDomain = '域名'
t.oss.fastdfsDomainTips = '绑定的域名，如：http://cdn.xianbao.io'
...
/* Xshop */
t.member = {}
t.member.selectLevel = '请选择会员等级'

t.member.lvName = '等级名称'
t.member.lvCondition = '升级条件'
t.member.discount = '折扣率'
t.member.description = '等级描述'
