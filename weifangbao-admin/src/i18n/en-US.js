...
t.login.demo = 'Demo'
t.login.copyright = 'xianbao'

t.home = {}
t.home.sysInfo = {}
t.home.sysInfo.name = 'System Name'
t.home.sysInfo.nameVal = 'xianbao-security [Enterprise]'
...
t.oss.aliyunDomainTips = 'Alibaba Cloud bound domain name, such as: http://cdn.xianbao.io'
...
t.oss.localDomainTips = 'Binded domain name, eg http://cdn.xianbao.io'
t.oss.fastdfsDomain = 'Domain Name'
t.oss.fastdfsDomainTips = 'Binded domain name, eg http://cdn.xianbao.io'
...
/* Xshop */
t.member = {}
t.member.selectLevel = 'choose member level'

t.member.lvName = 'level name'
t.member.lvCondition = 'upgrade condition'
t.member.discount = 'discount rate'
t.member.description = 'level description'

t.help = {}
t.help.type = 'type name'
t.help.show = 'is show'
